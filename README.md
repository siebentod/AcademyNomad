...
- Показывает все хайлайты последних измененных документов, отсортированные по дате добавления.
- Можно проводить поиск по всем хайлайтам в последних файлах или в файлах, добавленных в проект.
- Поиск по названиям всех PDF файлов в системе (благодаря `Everything SDK`).
